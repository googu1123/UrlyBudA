    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">                
            ...
            <section class="content">
                ...
                <div class="tbl_view">
                    <form action="msgDaysChart.tsis" method="post" id="mainForm">
                        <dl>
                            <dt>조회 기간</dt>
                            <dd>
                    ...
                    <form action="#" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right">
                                <p class="padt5 text-orange"><b>검색 건 : ${totalSize }</b></p>
                            </div>
                        </div><!-- /.row -->
                        ...
                        <table class="table tbl_list mart10">
                            <thead>
                                <tr>
                                    <th scope="col" rowspan="2" class="valign_mid">발송일자</th>
                            	...
                            	<c:choose>
                            		<c:when test="${fn:length(chart) > 0 }">
                            			<c:forEach var="ch" items="${chart }" varStatus="status">
                            				<tr>
			                                    <td><a href="#" class="detail" data-sdate="${ch.report_date }">${ch.report_date }</a></td>
			                                    <td>
...
$(document).ready(function(){
	...
	$("#btnExcel").on("click",function(){
		$("#mainForm").attr({"action":"msgChartDown.tsis"}).submit();
	});
	...
	$(".detail").on("click", function(){
		if($("#day_type").val() =="M"){
			var m = $(this).data("sdate").split("-")[1];
			var last_date = $(this).data("sdate");
        	if(m == "02"){
        		last_date+="-29";
			...
			movePage({"start_date":$(this).data("sdate")+"-01", "last_date":last_date,"day_type":$("#day_type").val()},"msgDaysChartDetail.tsis");	
		} else {
			movePage({"start_date":$(this).data("sdate"), "last_date":$(this).data("sdate"),"day_type":$("#day_type").val()},"msgDaysChartDetail.tsis");
		}
	});
