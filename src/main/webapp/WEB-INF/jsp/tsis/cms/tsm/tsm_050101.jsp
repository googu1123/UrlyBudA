            ...
            <section class="content">
                <div class="tbl_view">
                    <form action="#" method="post" id="mainForm" name="mainForm">
                    	...
                    	<input type="hidden" id="content" name="content" value="${tmp.content }"/>
                            ...
                            <table class="table tbl_write">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" rows="7" name="res_message" id="res_message"
												hname="답변" required="maxbyte" maxbyte="${len_res_message}"
                                            	onkeyup="textCounter(this.form.res_message, 'res_message_cnt', ${len_res_message});"></textarea>
                                           	<input type="hidden" id="len_res_message" value="${len_res_message}"/>
                                            <p class="help-block text-right" id="res_message_cnt"></p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="search_btn">
                            <button type="button" id="btnDefer" class="btn btn-danger">보류</button>
...
$(document).ready(function(){
	...
	$("#btnDefer").on("click", function(){
		$("#status").val("ING");
		$("#mainForm").attr({"action":"callCenterHelpDeferUpdate.tsis","method":"post"}).submit();
	});
	// 등록
	$("#btnRegi").on("click", function(){
		...
		$("#status").val("END");
		$("#mainForm").attr({"action":"callCenterHelpUpdate.tsis","method":"post"}).submit();
	});
	// 취소
